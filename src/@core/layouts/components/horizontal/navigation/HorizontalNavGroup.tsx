...
const HorizontalNavGroup = (props: Props) => {
  // ** Props
  const { item, hasParent, config } = props
  ...
  const horizontalMenuAnimation = false
  const horizontalMenuToggle = 'click'
            ...
            <AnimationWrapper>
              <Box
                ...
                sx={{
                  ...
                  pl: childMenuGroupStyles() === 'left' ? 2.25 : 0,
                  pr: childMenuGroupStyles() === 'right' ? 2.25 : 0,
                  ...(hasParent ? { position: 'fixed !important' } : { pt: 5.75 })
                }}
              >
                <NavigationMenu
                  sx={{
                ...
                >
                  <HorizontalNavItems {...props} hasParent navMenu={item.children} />
                </NavigationMenu>
              </Box>
            </AnimationWrapper>
          </List>
